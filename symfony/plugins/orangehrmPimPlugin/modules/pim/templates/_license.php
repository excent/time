...
<?php if ($licensePermissions->canCreate() || ($haveLicense && $licensePermissions->canUpdate())) { ?>
    <div id="changeLicense">
        <div class="head">
            <h1 id="headChangeLicense"><?php echo __('Add Certification'); ?></h1>
        </div>
                ...
                <table id="" cellpadding="0" cellspacing="0" width="100%" class="table tablesorter">
                    <thead>
                        <tr>
                            ...
                            <?php } ?>
                            <th><?php echo __('Certification Type'); ?></th>
...
<script type="text/javascript">
    ...
    var fileModified = 0;
    var lang_addLicense = "<?php echo __('Add Certification');?>";
    var lang_editLicense = "<?php echo __('Edit Certification');?>";
